      ...
      <div className="information-container">
        ...
        <div className="information-section-container">
          <section className="information-section">
            ...
            <h2>Release Date : {Location?.state?.Details?.date}</h2>
            {/* <AuthorNsocial
              author="Daniel Shi"
            ...
            <div className="click-zoom">
              <label>
                ...
                <img
                  className="image-1"
                  // src={Location?.state?.Details?.url}
                  style={{
                    backgroundImage: `url(${Location?.state?.Details?.photoUrl})`,
                  }}
                  alt=""
                />
              </label>
            </div>
            <p className="about">{Location?.state?.Details?.paragraph}</p>
            ...
            <Author
              author="Daniel Shi"
              avatar={Location?.state?.Details?.photoUrl}
            />
            <Divider /> */}
          </section>
        </div>
...
export default BollywoodInside;
...
//         photoUrl={Location?.state?.Details?.url}
//       />
//     </div>
//   );
// }
